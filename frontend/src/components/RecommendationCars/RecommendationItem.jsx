...
const RecommendationItem = ({ Name, Price, Location, ProductionDate, WheelType, FuelType, PassengerCapacity, CarRating, ReviewsCount }) => {
    console.log({ Name, Price, Location, ProductionDate, WheelType, FuelType, PassengerCapacity, CarRating, ReviewsCount })
    return (
